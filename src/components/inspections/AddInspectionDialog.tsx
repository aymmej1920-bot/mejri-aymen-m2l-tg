...
const AddInspectionDialog: React.FC = () => {
  ...
  const form = useForm<AddInspectionFormValues>({ // Utilisation du type inféré par Zod
  ...
  const onSubmit = (values: AddInspectionFormValues) => { // Utilisation du type inféré par Zod
    try {
